...
<body style="overflow: hidden;">
    <div id="cancelDiv" v-cloak>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-xs-4" style="vertical-align: middle;">
                            <div>
                                <button type="button" class="btn btn-info btn-lg btn-block" @click="toCheckout">反结账&nbsp;&nbsp;￥{{summary_price}}</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <%@ include file="./_cancel/_goods-select.jsp"%>
        <%@ include file="./_cancel/_vip-select.jsp"%>
        <%@ include file="./_cancel/_checkout.jsp"%>
    </div>
    <script src="${ctx}/static/js/frontstage/_cancel.js"></script>
</body>
