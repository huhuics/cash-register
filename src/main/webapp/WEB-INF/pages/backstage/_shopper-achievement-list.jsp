...
<body>
    <div id="shopperAchievementListDiv" v-cloak>
        <!-- 分页表格 -->
        <div>
            <div class="grid-btn">
                <div class="form-group col-xs-2">
                    <select class="form-control" v-model="q.bizNo">
                        ...
                        <option v-for="shopper in shoppers" :value="shopper.shopperNo">{{shopper.shopperNo}}</option>
                    </select>
                </div>
                <div class="form-group col-xs-2">
    ...
    <script src="${ctx}/static/js/backstage/_shopper-achievement-list.js"></script>
</body>
