    ...
    methods: {
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    if (result.code == "00") {
                                        ...
                                        num_failed++;
                                        err_msg += _self.goods.goodsName + '创建失败[' + result.msg + ']';
                                    }
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        ...
                        if (!isBlank(_self.goods.goodsTag)) {
        ...
        batchUpdate: function() { // 批量编辑
            ...
            layer.open({
                type: 1,
                skin: 'layui-layer-lan',
                title: "批量编辑" + goodsIds.length + "个商品",
                area: '600px',
                shadeClose: false,
        ...
        getPinyinCode: function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.goods.pinyinCode = result.pinyin;
                    } else {
        ...
        addGoodsColor: function() { // 添加颜色
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsColors();
                        _self.resetGoodsColor();
                    } else {
        ...
        deleteGoodsColorById: function(id) { // 根据id删除颜色
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsColors();
                        _self.select_goods_colors = []; // 删除颜色成功后清空选择
                    } else {
        ...
        addGoodsSize: function() { // 添加尺码
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsSizes();
                        _self.resetGoodsSize();
                    } else {
        ...
        deleteGoodsSizeById: function(id) { // 根据id删除尺码
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsSizes();
                        _self.select_goods_sizes = []; // 删除尺码成功后清空选择
                    } else {
        ...
        addGoodsUnit: function() { // 添加单位
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsUnits();
                        _self.resetGoodsUnit();
                    } else {
        ...
        deleteGoodsUnitById: function(id) { // 根据id删除单位
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsUnits();
                        _self.goods.quantityUnit = null; // 删除单位成功后清空选择
                    } else {
        ...
        addGoodsBrand: function() { // 添加品牌
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsBrands();
                        _self.resetGoodsBrand();
                    } else {
        ...
        deleteGoodsBrandById: function(id) { // 根据id删除品牌
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsBrands();
                        _self.goods.goodsBrand = null; // 删除品牌成功后清空选择
                    } else {
        ...
        deleteGoodsTagById: function(id) { // 根据id删除标签
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == "00") {
                        _self.loadGoodsTags();
                        _self.select_goods_tags = []; // 删除标签成功后清空选择
                    } else {
