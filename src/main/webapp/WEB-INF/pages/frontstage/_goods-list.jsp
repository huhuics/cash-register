...
<body>
    ...
    <script src="${ctx}/static/js/frontstage/_goods-list/var-jqGrid-option.js"></script>
    <script src="${ctx}/static/js/frontstage/_goods-list/var-goods-entity.js"></script>
    <script src="${ctx}/static/js/frontstage/_goods-list/var-vue-data.js"></script>
    <script src="${ctx}/static/js/frontstage/_goods-list.js"></script>
