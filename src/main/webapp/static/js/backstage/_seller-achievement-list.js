$(function() {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: '销售价', name: 'totalAmount', index: 'total_Amount', width: 80 },
            { label: '数量', name: 'goodsCount', index: 'goods_Count', sortable: false, width: 80 },
            { label: '总价', name: 'summary', index: 'summary', width: 80, 
            	formatter: function(value, options, row) {
                    return 1 * row['totalAmount'] * row['goodsCount'];
                },
            },
            { label: '实收', name: 'totalActualAmount', index: 'total_Actual_Amount', width: 80 },
            { label: '利润', name: 'profitAmount', index: 'profit_Amount', width: 80 },
